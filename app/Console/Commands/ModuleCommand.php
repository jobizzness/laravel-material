...
class ModuleCommand extends Command
{
    ...
    public function handle()
    {
        ...
        if (!is_dir('app/Modules/'.ucfirst($module))) {
            ...
            mkdir('app/Modules/'.ucfirst($module).'/Rules', 0777, true);
            mkdir('app/Modules/'.ucfirst($module).'/Mail', 0777, true);
            mkdir('app/Modules/'.ucfirst($module).'/Events', 0777, true);
            mkdir('app/Modules/'.ucfirst($module).'/Listeners', 0777, true);
        }
